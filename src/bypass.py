    ...
    def click_verification_button(self):
        try:
            ...
            if button:
                ...
                time.sleep(1)
                self.driver.get_screenshot('error2.png')
                button.click()
                self.log_message('Clicked verification button')
                time.sleep(10)
                self.driver.get_screenshot('error3.png')
...
# driver = ChromiumPage()
# driver.get('https://visa.vfsglobal.com/aze/en/ita/login')
